...
export default function Home() {
  // Client-Side Injection Hook
  useEffect(() => {
    // 1. Force inject the required styling layout stylesheet
    ...
    // 2. Force inject the external checkout core program script
    ...
    <main className="min-h-screen bg-gray-50 py-12 px-6">
      ...
      <header className="max-w-4xl mx-auto text-center mb-12">
        ...
        <p className="mt-2 text-lg text-gray-600">
          Premium streetwear. Managed with production scripts.
        </p>
      </header>
      ...
      <section className="max-w-4xl mx-auto flex justify-center">
        <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 p-6 w-full max-w-sm flex flex-col justify-between">
          ...
          <div className="mt-6">
            ...
            {/* Native Snipcart auto-binding tracking click handler */}
            <button 
